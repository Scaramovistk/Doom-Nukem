...
# Source Files
SRC_MAIN		=	main.c
SRC_EVENTS		=	door_bonus.c events.c game_loop.c hooks.c hooks_door_bonus.c interact.c message.c mlx_mouse_pos_bonus.c pickup.c \
					stop_game.c triggers.c update_player_pos.c
